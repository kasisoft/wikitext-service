 ...
 */
public class ConfluenceWikiServiceTest extends AbstractWikiServiceTest<ConfluenceWikiService> {

  public ConfluenceWikiServiceTest() {
    super( ConfluenceWikiService.class );
  }
